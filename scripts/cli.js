...
const contractABI = require("../artifacts/contracts/Flangerprism.sol/Flangerprism.json").abi;

program
    .name("flangerprism-cli")
    .description("CLI tool for Flangerprism smart contract")
    .version("1.0.0");
